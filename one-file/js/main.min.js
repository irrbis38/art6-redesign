...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),i=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),a=e=>{e.target.closest("li").classList.add("active")},r=e=>e.target.classList.remove("active"),n=()=>{i.forEach(e=>e.addEventListener("mouseover",a)),t.forEach(e=>e.addEventListener("mouseleave",r))};991<window.innerWidth&&n();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(i.forEach(e=>e.removeEventListener("mouseover",a)),t.forEach(e=>e.removeEventListener("mouseleave",r))):n()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),s=e=>{var t=e.target.parentElement,i=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),i.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),i.style.maxHeight=i.scrollHeight+"px"})},c=(e.forEach(e=>e.addEventListener("click",s)),document.body),o=document.getElementById("header"),e=document.getElementById("burger-button"),l=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{o.classList.toggle("mobile-menu-open"),c.classList.toggle("lock"),l.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})})},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),i=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),i.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var r=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=r.map(e=>e.children[0]),n=r.map(e=>e.children[1]),t=r[0],i=t.children[1],s=(t.classList.add("active"),i.style.maxHeight=i.scrollHeight+"px",i);e.forEach(a=>a.addEventListener("click",()=>{var e=a.parentElement,t=e.classList.contains("active"),i=a.nextElementSibling;s=t?(e.classList.remove("active"),i.style.maxHeight=null):(r.forEach(e=>e.classList.remove("active")),n.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),i.style.maxHeight=i.scrollHeight+"px",i)})),window.addEventListener("resize",()=>s&&(s.style.maxHeight=s.scrollHeight+"px"))},initAccordion=(e,i)=>{var a=Array.from(document.querySelectorAll(e)),t=e=>{var t,e=e.target.closest(i);e&&(t=e.parentElement,e=e.nextElementSibling,t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(a.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px"))},r=()=>{var e=a.filter(e=>e.classList.contains("active"));0<e.length&&((e=e[0].children[1]).style.maxHeight=e.scrollHeight+"px")};window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(a[0].classList.add("active"),a.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",r)})):(a.forEach(e=>e.classList.remove("active")),a.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",r)}))}),window.innerWidth<=991&&(a.forEach(e=>e.addEventListener("click",t)),a[0].classList.add("active"),a[0].children[1].style.maxHeight=a[0].children[1].scrollHeight+"px",window.addEventListener("resize",r))};document.addEventListener("DOMContentLoaded",function(e){initSmothScroll(),initHeader(),document.querySelector(".index")&&(initTeamSlider(),initQuestionsAccordion(),initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"))});