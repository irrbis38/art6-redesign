...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),s=e=>{e.target.closest("li").classList.add("active")},a=e=>e.target.classList.remove("active"),c=()=>{r.forEach(e=>e.addEventListener("mouseover",s)),t.forEach(e=>e.addEventListener("mouseleave",a))};991<window.innerWidth&&c();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",s)),t.forEach(e=>e.removeEventListener("mouseleave",a))):c()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),i=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},o=(e.forEach(e=>e.addEventListener("click",i)),document.body),n=document.getElementById("header"),e=document.getElementById("burger-button"),l=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{n.classList.toggle("mobile-menu-open"),o.classList.toggle("lock"),l.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})})},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),r=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),r.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var a=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=a.map(e=>e.children[0]),c=a.map(e=>e.children[1]),t=a[0],r=t.children[1],i=(t.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r);e.forEach(s=>s.addEventListener("click",()=>{var e=s.parentElement,t=e.classList.contains("active"),r=s.nextElementSibling;i=t?(e.classList.remove("active"),r.style.maxHeight=null):(a.forEach(e=>e.classList.remove("active")),c.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r)})),window.addEventListener("resize",()=>i&&(i.style.maxHeight=i.scrollHeight+"px"))},initAccordion=(e,r)=>{var s=Array.from(document.querySelectorAll(e)),a=null,t=e=>{var t,e=e.target.closest(r);e&&(t=e.parentElement,e=e.nextElementSibling,a=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(s.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},c=()=>a&&(a.style.maxHeight=a.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(s[0].classList.add("active"),s.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",c)})):(s.forEach(e=>e.classList.remove("active")),s.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",c)}))}),window.innerWidth<=991&&(s.forEach(e=>e.addEventListener("click",t)),s[0].classList.add("active"),a=s[0].children[1],s[0].children[1].style.maxHeight=s[0].children[1].scrollHeight+"px",window.addEventListener("resize",c))},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),s=document.body,a=document.querySelector(".scr_b_client_art6__btn"),c=document.querySelector(".scr_b_client_art6__overlay");[e,t].forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),s.classList.add("lock")})),[a,c].forEach(e=>e.addEventListener("click",()=>{r.classList.remove("active"),s.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),s.classList.remove("lock"))})},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body;[document.querySelector(".scr_success_msg_art6__btn"),document.querySelector(".scr_success_msg_art6__overlay")].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,s=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),a=document.querySelector(".scr_cities_art6__overlay"),c=Array.from(document.querySelectorAll(".scr_cities_art6__input")),i=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{s.classList.add("active"),r.classList.add("lock")}),[e,a].forEach(e=>e.addEventListener("click",()=>{s.classList.remove("active"),r.classList.remove("lock"),i.value="",c.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(s.classList.remove("active"),r.classList.remove("lock"),i.value="",c.forEach(e=>e.classList.remove("hidden")))}),c.forEach(e=>e.addEventListener("click",()=>{s.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,i.value="",c.forEach(e=>e.classList.remove("hidden"))})),i.addEventListener("input",()=>{c.forEach(e=>{e.value.toLowerCase().includes(i.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})};document.addEventListener("DOMContentLoaded",function(e){initSmothScroll(),initHeader(),toggleBecomeClient(),changeCity(),document.querySelector(".index")&&(initTeamSlider(),initQuestionsAccordion(),initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),checkRequiredInputs(),formValidation(),handleSuccessMsgModal())});