...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),a=e=>{e.target.closest("li").classList.add("active")},n=e=>e.target.classList.remove("active"),o=()=>{r.forEach(e=>e.addEventListener("mouseover",a)),t.forEach(e=>e.addEventListener("mouseleave",n))};991<window.innerWidth&&o();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",a)),t.forEach(e=>e.removeEventListener("mouseleave",n))):o()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),i=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},s=(e.forEach(e=>e.addEventListener("click",i)),document.body),m=document.getElementById("header"),e=document.getElementById("burger-button"),d=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{m.classList.toggle("mobile-menu-open"),s.classList.toggle("lock"),d.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})})};document.addEventListener("DOMContentLoaded",function(e){luxy.init(),initHeader();var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),r=document.querySelector(".scr_komanda_art6__next"),a=document.querySelector(".scr_komanda_art6__prev");r.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),a.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()});