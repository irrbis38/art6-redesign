...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),a=e=>{e.target.closest("li").classList.add("active")},i=e=>e.target.classList.remove("active"),c=()=>{r.forEach(e=>e.addEventListener("mouseover",a)),t.forEach(e=>e.addEventListener("mouseleave",i))};991<window.innerWidth&&c();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",a)),t.forEach(e=>e.removeEventListener("mouseleave",i))):c()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),s=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},n=(e.forEach(e=>e.addEventListener("click",s)),document.body),o=document.getElementById("header"),e=document.getElementById("burger-button"),l=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{o.classList.toggle("mobile-menu-open"),n.classList.toggle("lock"),l.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})})},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),r=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),r.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var i=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=i.map(e=>e.children[0]),c=i.map(e=>e.children[1]),t=i[0],r=t.children[1],s=(t.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r);e.forEach(a=>a.addEventListener("click",()=>{var e=a.parentElement,t=e.classList.contains("active"),r=a.nextElementSibling;s=t?(e.classList.remove("active"),r.style.maxHeight=null):(i.forEach(e=>e.classList.remove("active")),c.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r)})),window.addEventListener("resize",()=>s&&(s.style.maxHeight=s.scrollHeight+"px"))},initAccordion=(e,r)=>{var a=Array.from(document.querySelectorAll(e)),i=null,t=e=>{var t,e=e.target.closest(r);e&&(t=e.parentElement,e=e.nextElementSibling,i=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(a.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},c=()=>i&&(i.style.maxHeight=i.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(a[0].classList.add("active"),a.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",c)})):(a.forEach(e=>e.classList.remove("active")),a.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",c)}))}),window.innerWidth<=991&&(a.forEach(e=>e.addEventListener("click",t)),a[0].classList.add("active"),i=a[0].children[1],a[0].children[1].style.maxHeight=a[0].children[1].scrollHeight+"px",window.addEventListener("resize",c))},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),a=document.body,i=document.querySelector(".scr_b_client_art6__btn"),c=document.querySelector(".scr_b_client_art6__overlay");[e,t].forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),a.classList.add("lock")})),[i,c].forEach(e=>e.addEventListener("click",()=>{r.classList.remove("active"),a.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),a.classList.remove("lock"))})},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body;[document.querySelector(".scr_success_msg_art6__btn"),document.querySelector(".scr_success_msg_art6__overlay")].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,a=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),i=document.querySelector(".scr_cities_art6__overlay"),c=Array.from(document.querySelectorAll(".scr_cities_art6__input")),s=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{a.classList.add("active"),r.classList.add("lock")}),[e,i].forEach(e=>e.addEventListener("click",()=>{a.classList.remove("active"),r.classList.remove("lock"),s.value="",c.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(a.classList.remove("active"),r.classList.remove("lock"),s.value="",c.forEach(e=>e.classList.remove("hidden")))}),c.forEach(e=>e.addEventListener("click",()=>{a.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,s.value="",c.forEach(e=>e.classList.remove("hidden"))})),s.addEventListener("input",()=>{c.forEach(e=>{e.value.toLowerCase().includes(s.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})},startScrollingBlockAnimation=()=>{var e=(e,t,r,a)=>{var i=document.querySelector(e),c=document.querySelector(r);function s(){return-(i.scrollWidth-Number(c.clientWidth))}e=gsap.to(i,{x:s,duration:3,ease:"none"});ScrollTrigger.create({trigger:t,start:a,end:()=>"+="+-1*s(),scrub:1,pin:!0,animation:e,invalidateOnRefresh:!0,markers:!0,toggleActions:"play none none reverse"})};e(".scr_scrolling_right_art6__scroll",".scr_scrolling_right_art6",".scr_scrolling_right_art6 .container","top 10%"),e(".scr_uslugi_art6__title",".scr_uslugi_art6",".scr_uslugi_art6 .container","top 30%"),e(".scr_keysy_art6__title",".scr_keysy_art6",".scr_keysy_art6 .container","top 30%"),e(".scr_text_director_art6__title",".scr_text_director_art6",".first_scr_main_art6 .container","top -10%"),e(".scr_tematiki_art6__title",".scr_tematiki_art6__title__block",".scr_tematiki_art6 .container","top 30%"),e(".scr_company_art6__title",".scr_company_art6",".first_scr_main_art6 .container","top top")};document.addEventListener("DOMContentLoaded",function(e){initHeader(),toggleBecomeClient(),changeCity(),document.querySelector(".index")&&(initTeamSlider(),initQuestionsAccordion(),initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),checkRequiredInputs(),formValidation(),handleSuccessMsgModal(),991<window.innerWidth&&(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation()),window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation(),console.log("change"))}))});