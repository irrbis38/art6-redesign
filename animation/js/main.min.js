...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),i=e=>{e.target.closest("li").classList.add("active")},a=e=>e.target.classList.remove("active"),s=()=>{r.forEach(e=>e.addEventListener("mouseover",i)),t.forEach(e=>e.addEventListener("mouseleave",a))};991<window.innerWidth&&s();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",i)),t.forEach(e=>e.removeEventListener("mouseleave",a))):s()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),c=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},n=(e.forEach(e=>e.addEventListener("click",c)),document.body),o=document.getElementById("header"),e=document.getElementById("burger-button"),l=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{o.classList.toggle("mobile-menu-open"),n.classList.toggle("lock"),l.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})})},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),r=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),r.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var a=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=a.map(e=>e.children[0]),s=a.map(e=>e.children[1]),t=a[0],r=t.children[1],c=(t.classList.add("active"),r.style.maxHeight=r.scrollHeight+25+"px",r);e.forEach(i=>i.addEventListener("click",()=>{var e=i.parentElement,t=e.classList.contains("active"),r=i.nextElementSibling;c=t?(e.classList.remove("active"),r.style.maxHeight=null):(a.forEach(e=>e.classList.remove("active")),s.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r)})),window.addEventListener("resize",()=>c&&(c.style.maxHeight=c.scrollHeight+"px"))},initAccordion=(e,r)=>{var i=Array.from(document.querySelectorAll(e)),a=null,t=e=>{var t,e=e.target.closest(r);e&&(t=e.parentElement,e=e.nextElementSibling,a=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(i.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},s=()=>a&&(a.style.maxHeight=a.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?i.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",s)}):(i.forEach(e=>e.classList.remove("active")),i.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",s)}))}),window.innerWidth<=991&&(i.forEach(e=>e.addEventListener("click",t)),i[0].classList.add("active"),a=i[0].children[1],i[0].children[1].style.maxHeight=i[0].children[1].scrollHeight+"px",window.addEventListener("resize",s))},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),i=document.body,a=document.querySelector(".scr_b_client_art6__btn"),s=document.querySelector(".scr_b_client_art6__overlay");[e,t].forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),i.classList.add("lock")})),[a,s].forEach(e=>e.addEventListener("click",()=>{r.classList.remove("active"),i.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),i.classList.remove("lock"))})},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body;[document.querySelector(".scr_success_msg_art6__btn"),document.querySelector(".scr_success_msg_art6__overlay")].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,i=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),a=document.querySelector(".scr_cities_art6__overlay"),s=Array.from(document.querySelectorAll(".scr_cities_art6__input")),c=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{i.classList.add("active"),r.classList.add("lock")}),[e,a].forEach(e=>e.addEventListener("click",()=>{i.classList.remove("active"),r.classList.remove("lock"),c.value="",s.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(i.classList.remove("active"),r.classList.remove("lock"),c.value="",s.forEach(e=>e.classList.remove("hidden")))}),s.forEach(e=>e.addEventListener("click",()=>{i.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,c.value="",s.forEach(e=>e.classList.remove("hidden"))})),c.addEventListener("input",()=>{s.forEach(e=>{e.value.toLowerCase().includes(c.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})},startScrollingBlockAnimation=()=>{var e=(e,t,r,i)=>{var a=document.querySelector(e),s=document.querySelector(r);function c(){var e=a.scrollWidth;return window.innerWidth<1280?-(e-Number(s.clientWidth-80)):-(e-Number(s.clientWidth)+80)}let n=gsap.matchMedia();n.add("(min-width: 992px)",()=>{gsap.to(a,{x:c,duration:3,ease:"none",scrollTrigger:{trigger:t,start:i,end:()=>"+="+-1*c(),scrub:1.5,pin:!0,invalidateOnRefresh:!0,toggleActions:"play none none reverse"}})})};e(".scr_scrolling_right_art6__scroll",".scr_scrolling_right_art6",".scr_scrolling_right_art6 .container","top 10%"),e(".scr_uslugi_art6__title",".scr_uslugi_art6",".scr_uslugi_art6 .container","top 30%"),e(".scr_keysy_art6__title",".scr_keysy_art6",".scr_keysy_art6 .container","top 30%"),e(".scr_text_director_art6__title",".scr_text_director_art6",".first_scr_main_art6 .container","top -10%"),e(".scr_company_art6__title",".scr_company_art6",".first_scr_main_art6 .container","top top")},initAnimation=()=>{var e=document.querySelector(".first_word .letter");gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.set(e,{y:"-54%"}),gsap.timeline({scrollTrigger:{trigger:".scr_scrolling_right_art6",start:"45% center",end:"60% center",scrub:1,pin:!1,invalidateOnRefresh:!0,duration:3}}).to(e,{y:-.3})})},initTematikiAnimation=()=>{var e=document.querySelector(".scr_tematiki_art6__wrapper");gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.set(e,{y:150}),gsap.timeline({scrollTrigger:{trigger:".scr_tematiki_art6__inner",start:"center center",end:"bottom center",scrub:1,pin:!1,invalidateOnRefresh:!0,duration:3}}).to(e,{y:0})})};document.addEventListener("DOMContentLoaded",function(e){var t;initHeader(),toggleBecomeClient(),changeCity(),document.querySelector(".index")&&(initTeamSlider(),initQuestionsAccordion(),initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),checkRequiredInputs(),formValidation(),handleSuccessMsgModal(),t=!1,991<window.innerWidth&&(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation(),t=!0,initAnimation(),initTematikiAnimation()),window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||t||(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation(),initAnimation(),initTematikiAnimation())}))});