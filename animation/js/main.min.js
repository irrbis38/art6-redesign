...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),a=e=>{e.target.closest("li").classList.add("active")},o=e=>e.target.classList.remove("active"),c=()=>{r.forEach(e=>e.addEventListener("mouseover",a)),t.forEach(e=>e.addEventListener("mouseleave",o))};991<window.innerWidth&&c();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",a)),t.forEach(e=>e.removeEventListener("mouseleave",o))):c()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),s=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},i=(e.forEach(e=>e.addEventListener("click",s)),document.body),n=document.getElementById("header"),e=document.getElementById("burger-button"),d=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{n.classList.toggle("mobile-menu-open"),i.classList.toggle("lock"),d.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})});{let r=window.scrollY||document.documentElement.scrollTop,a,o=0,c=0;const l=document.querySelector(".header_art6");return void window.addEventListener("scroll",()=>{if(a=window.scrollY||document.documentElement.scrollTop,a>r?o=2:a<r&&(o=1),o!==c){var e=o,t=a;if(e===2&&t>100){if(!l.classList.contains("mobile-menu-open")){l.classList.add("hide");c=e}}else if(e===1){l.classList.remove("hide");c=e}}r=a})}},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),r=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),r.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var o=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=o.map(e=>e.children[0]),c=o.map(e=>e.children[1]),t=o[0],r=t.children[1],s=(t.classList.add("active"),r.style.maxHeight=r.scrollHeight+25+"px",r);e.forEach(a=>a.addEventListener("click",()=>{var e=a.parentElement,t=e.classList.contains("active"),r=a.nextElementSibling;s=t?(e.classList.remove("active"),r.style.maxHeight=null):(o.forEach(e=>e.classList.remove("active")),c.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r)})),window.addEventListener("resize",()=>s&&(s.style.maxHeight=s.scrollHeight+"px"))},initAccordion=(e,a)=>{var o=Array.from(document.querySelectorAll(e)),c=null,t=e=>{var t,r,e=e.target.closest(a);e&&(r=(t=e.parentElement).classList.contains("one-per-view"),e=e.nextElementSibling,c=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(r&&o.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},r=()=>c&&(c.style.maxHeight=c.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?o.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",r)}):(o.forEach(e=>e.classList.remove("active")),o.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",r)}))}),window.innerWidth<=991&&(o.forEach(e=>e.addEventListener("click",t)),window.addEventListener("resize",r))},toggleModal=e=>{const{buttons_open:t,client_modal:r,body:a,header:o,close_btn:c,overlay:s}=e;t.forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),a.classList.add("lock")})),[c,s].forEach(e=>e.addEventListener("click",()=>{r.classList.remove("active"),o.classList.contains("mobile-menu-open")||a.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),o.classList.contains("mobile-menu-open")||a.classList.remove("lock"))})},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),a=document.body,o=document.querySelector(".scr_b_client_art6__btn"),c=document.querySelector(".scr_b_client_art6__overlay"),s=document.querySelector(".header_art6");toggleModal({buttons_open:[e,t],client_modal:r,body:a,header:s,close_btn:o,overlay:c})},toggleConsultationModal=()=>{var e=document.querySelector(".scr_text_director_art6__consultation"),t=document.querySelector(".scr_b_consultation_art6"),r=document.body,a=document.querySelector(".scr_b_consultation_art6__btn"),o=document.querySelector(".scr_b_consultation_art6__overlay"),c=document.querySelector(".header_art6");toggleModal({buttons_open:[e],client_modal:t,body:r,header:c,close_btn:a,overlay:o})},handleShowReviewButtons=()=>{var e=Array.from(document.querySelectorAll(".scr_klienty_onas_art6__pdf")),e=(client_modal=document.querySelector(".scr_review_modal"),body=document.body,close_btn=document.querySelector(".scr_review_modal__btn"),overlay=document.querySelector(".scr_review_modal__overlay"),header=document.querySelector(".header_art6"),image=document.querySelector(".scr_review_modal__image img"),e.forEach(e=>e.addEventListener("click",()=>{image.src=e.dataset.src})),{buttons_open:e,client_modal:client_modal,body:body,header:header,close_btn:close_btn,overlay:overlay});toggleModal(e)},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body,e=document.querySelector(".scr_success_msg_art6__btn"),a=document.querySelector(".scr_success_msg_art6__overlay"),o=document.querySelector(".header_art6");[e,a].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),o.classList.contains("mobile-menu-open")||r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,a=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),o=document.querySelector(".scr_cities_art6__overlay"),c=Array.from(document.querySelectorAll(".scr_cities_art6__input")),s=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{a.classList.add("active"),r.classList.add("lock")}),[e,o].forEach(e=>e.addEventListener("click",()=>{a.classList.remove("active"),r.classList.remove("lock"),s.value="",c.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(a.classList.remove("active"),header.classList.contains("mobile-menu-open")||r.classList.remove("lock"),s.value="",c.forEach(e=>e.classList.remove("hidden")))}),c.forEach(e=>e.addEventListener("click",()=>{a.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,s.value="",c.forEach(e=>e.classList.remove("hidden"))})),s.addEventListener("input",()=>{c.forEach(e=>{e.value.toLowerCase().includes(s.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})},startScrollingBlockAnimation=()=>{var e=(e,t,r,a)=>{var o=document.querySelector(e),c=document.querySelector(r);function s(){var e=o.scrollWidth;return window.innerWidth<1280?-(e-Number(c.clientWidth-80)):-(e-Number(c.clientWidth)+80)}let i=gsap.matchMedia();i.add("(min-width: 992px)",()=>{gsap.to(o,{x:s,duration:3,ease:"none",scrollTrigger:{trigger:t,start:a,end:()=>"+="+-1*s(),scrub:1.5,pin:!0,invalidateOnRefresh:!0,toggleActions:"play none none reverse"}})})};e(".scr_scrolling_right_art6__scroll",".scr_scrolling_right_art6",".scr_scrolling_right_art6 .container","top 10%"),e(".scr_keysy_art6__title",".scr_keysy_art6",".scr_keysy_art6 .container","top 30%"),e(".scr_text_director_art6__title",".scr_text_director_art6",".first_scr_main_art6 .container","top -10%"),e(".scr_company_art6__title",".scr_company_art6",".first_scr_main_art6 .container","top top")},initAnimation=()=>{var e=document.querySelector(".first_word .letter");gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.set(e,{y:"-54%"}),gsap.timeline({scrollTrigger:{trigger:".scr_scrolling_right_art6",start:"45% center",end:"60% center",scrub:1,pin:!1,invalidateOnRefresh:!0,duration:3}}).to(e,{y:-.3})})},initCompanyPersonsAnimation=()=>{var a=Array.from(document.querySelectorAll(".scr_company_art6__person")),o=(a[0].classList.add("active"),a[0].classList.remove("hidden"),a[1].classList.remove("hidden"),0),c=a.length;setInterval(()=>{var e=o%c,t=(o+1)%c,r=(o+2)%c;a[e].classList.add("hidden"),a[e].classList.remove("active"),a[t].classList.add("active"),a[r].classList.remove("hidden"),o++},5e3)};document.addEventListener("DOMContentLoaded",function(e){var t;initHeader(),toggleBecomeClient(),toggleConsultationModal(),changeCity(),document.querySelector(".index")&&(initTeamSlider(),initQuestionsAccordion(),initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),initCompanyPersonsAnimation(),handleShowReviewButtons(),checkRequiredInputs(),formValidation(),handleSuccessMsgModal(),t=!1,991<window.innerWidth&&(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation(),t=!0,initAnimation()),window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||t||(gsap.registerPlugin(ScrollTrigger),startScrollingBlockAnimation(),initAnimation())}))});