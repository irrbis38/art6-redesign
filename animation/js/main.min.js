...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),c=e=>{e.target.closest("li").classList.add("active")},o=e=>e.target.classList.remove("active"),s=()=>{r.forEach(e=>e.addEventListener("mouseover",c)),t.forEach(e=>e.addEventListener("mouseleave",o))};991<window.innerWidth&&s();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",c)),t.forEach(e=>e.removeEventListener("mouseleave",o))):s()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),a=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},i=(e.forEach(e=>e.addEventListener("click",a)),document.body),n=document.getElementById("header"),e=document.getElementById("burger-button"),d=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",()=>{n.classList.toggle("mobile-menu-open"),i.classList.toggle("lock"),d.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})});{let r=window.scrollY||document.documentElement.scrollTop,c,o=0,s=0;const l=document.querySelector(".header_art6");return void window.addEventListener("scroll",()=>{if(c=window.scrollY||document.documentElement.scrollTop,c>r?o=2:c<r&&(o=1),o!==s){var e=o,t=c;if(e===2&&t>100){if(!l.classList.contains("mobile-menu-open")){l.classList.add("hide");s=e}}else if(e===1){l.classList.remove("hide");s=e}}r=c})}},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{var t=new Glide(".scr_komanda_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1300:{perView:3},991:{perView:2,gap:48},767:{perView:2,gap:20},575:{perView:1}}}),e=document.querySelector(".scr_komanda_art6__next"),r=document.querySelector(".scr_komanda_art6__prev");e.addEventListener("click",function(e){e.preventDefault(),t.go(">")}),r.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),t.mount()},initQuestionsAccordion=()=>{var o=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),e=o.map(e=>e.children[0]),s=o.map(e=>e.children[1]),t=o[0],r=t.children[1],a=(t.classList.add("active"),r.style.maxHeight=r.scrollHeight+25+"px",r);e.forEach(c=>c.addEventListener("click",()=>{var e=c.parentElement,t=e.classList.contains("active"),r=c.nextElementSibling;a=t?(e.classList.remove("active"),r.style.maxHeight=null):(o.forEach(e=>e.classList.remove("active")),s.forEach(e=>e.style.maxHeight=null),e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",r)})),window.addEventListener("resize",()=>a&&(a.style.maxHeight=a.scrollHeight+"px"))},initAccordion=(e,c)=>{var o=Array.from(document.querySelectorAll(e)),s=null,t=e=>{var t,r,e=e.target.closest(c);e&&(r=(t=e.parentElement).classList.contains("one-per-view"),e=e.nextElementSibling,s=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(r&&o.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},r=()=>s&&(s.style.maxHeight=s.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?o.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",r)}):(o.forEach(e=>e.classList.remove("active")),o.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",r)}))}),window.innerWidth<=991&&(o.forEach(e=>e.addEventListener("click",t)),window.addEventListener("resize",r))},toggleModal=e=>{const{buttons_open:t,client_modal:r,body:c,header:o,close_btn:s,overlay:a}=e;t.forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),c.classList.add("lock")})),[s,a].forEach(e=>e.addEventListener("click",()=>{r.classList.remove("active"),o.classList.contains("mobile-menu-open")||c.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),o.classList.contains("mobile-menu-open")||c.classList.remove("lock"))})},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),c=document.body,o=document.querySelector(".scr_b_client_art6__btn"),s=document.querySelector(".scr_b_client_art6__overlay"),a=document.querySelector(".header_art6");toggleModal({buttons_open:[e,t],client_modal:r,body:c,header:a,close_btn:o,overlay:s})},toggleConsultationModal=()=>{var e=document.querySelector(".scr_text_director_art6__consultation"),t=document.querySelector(".scr_b_consultation_art6"),r=document.body,c=document.querySelector(".scr_b_consultation_art6__btn"),o=document.querySelector(".scr_b_consultation_art6__overlay"),s=document.querySelector(".header_art6");toggleModal({buttons_open:[e],client_modal:t,body:r,header:s,close_btn:c,overlay:o})},handleShowReviewButtons=()=>{var e=Array.from(document.querySelectorAll(".scr_klienty_onas_art6__pdf")),t=document.querySelector(".scr_review_modal"),r=document.body,c=document.querySelector(".scr_review_modal__btn"),o=document.querySelector(".scr_review_modal__overlay"),s=document.querySelector(".header_art6"),a=document.querySelector(".scr_review_modal__image img");e.forEach(e=>e.addEventListener("click",()=>{a.src=e.dataset.src})),toggleModal({buttons_open:e,client_modal:t,body:r,header:s,close_btn:c,overlay:o})},showReviewOnProjectPage=()=>{var e=Array.from(document.querySelectorAll(".scr_rezultat_keysa_art6__img")),t=document.querySelector(".scr_review_modal"),r=document.body,c=document.querySelector(".scr_review_modal__btn"),o=document.querySelector(".scr_review_modal__overlay"),s=document.querySelector(".header_art6");document.querySelector(".scr_review_modal__image img");toggleModal({buttons_open:e,client_modal:t,body:r,header:s,close_btn:c,overlay:o})},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body,e=document.querySelector(".scr_success_msg_art6__btn"),c=document.querySelector(".scr_success_msg_art6__overlay"),o=document.querySelector(".header_art6");[e,c].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),o.classList.contains("mobile-menu-open")||r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,c=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),o=document.querySelector(".scr_cities_art6__overlay"),s=Array.from(document.querySelectorAll(".scr_cities_art6__input")),a=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{c.classList.add("active"),r.classList.add("lock")}),[e,o].forEach(e=>e.addEventListener("click",()=>{c.classList.remove("active"),r.classList.remove("lock"),a.value="",s.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(c.classList.remove("active"),header.classList.contains("mobile-menu-open")||r.classList.remove("lock"),a.value="",s.forEach(e=>e.classList.remove("hidden")))}),s.forEach(e=>e.addEventListener("click",()=>{c.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,a.value="",s.forEach(e=>e.classList.remove("hidden"))})),a.addEventListener("input",()=>{s.forEach(e=>{e.value.toLowerCase().includes(a.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})},startScrollingBlockAnimation=()=>{var e=(e,t,r,c)=>{var o=document.querySelector(e),s=document.querySelector(r);function a(){var e=o.scrollWidth;return window.innerWidth<1280?-(e-Number(s.clientWidth-80)):-(e-Number(s.clientWidth)+80)}let i=gsap.matchMedia();i.add("(min-width: 992px)",()=>{gsap.to(o,{x:a,duration:3,ease:"none",scrollTrigger:{trigger:t,start:c,end:()=>"+="+-1*a(),scrub:1.5,pin:!0,invalidateOnRefresh:!0,toggleActions:"play none none reverse"}})})},t=(document.querySelector(".scr_scrolling_right_art6")&&e(".scr_scrolling_right_art6__scroll",".scr_scrolling_right_art6",".scr_scrolling_right_art6 .container","top 10%"),document.querySelector(".scr_keysy_art6")),r=document.querySelector(".our-projects");t&&e(".scr_keysy_art6__title",".scr_keysy_art6",".scr_keysy_art6 .container",r?"top top":"top 30%"),document.querySelector(".scr_text_director_art6")&&e(".scr_text_director_art6__title",".scr_text_director_art6",".first_scr_main_art6 .container","top -10%"),document.querySelector(".scr_company_art6")&&e(".scr_company_art6__title",".scr_company_art6",".first_scr_main_art6 .container","top top"),document.querySelector(".first_scr_with_scroll")&&e(".first_scr_with_scroll__title",".first_scr_with_scroll",".first_scr_with_scroll .scroll_container","top top")},initAnimation=()=>{var e=document.querySelector(".first_word .letter");gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.set(e,{y:"-54%"}),gsap.timeline({scrollTrigger:{trigger:".scr_scrolling_right_art6",start:"45% center",end:"60% center",scrub:1,pin:!1,invalidateOnRefresh:!0,duration:3}}).to(e,{y:-.3})})},initCompanyPersonsAnimation=()=>{var c=Array.from(document.querySelectorAll(".scr_company_art6__person")),o=(c[0].classList.add("active"),c[0].classList.remove("hidden"),c[1].classList.remove("hidden"),0),s=c.length;setInterval(()=>{var e=o%s,t=(o+1)%s,r=(o+2)%s;c[e].classList.add("hidden"),c[e].classList.remove("active"),c[t].classList.add("active"),c[r].classList.remove("hidden"),o++},5e3)},initScrInstrumtechSlider=()=>{var t=new Glide(".scr_instrumtech_art6__slider",{type:"carousel",gap:20,perView:4,breakpoints:{1600:{gap:17},1300:{gap:13}}}),e=document.querySelector(".scr_instrumtech_art6__prev");document.querySelector(".scr_instrumtech_art6__next").addEventListener("click",function(e){e.preventDefault(),t.go(">")}),e.addEventListener("click",function(e){e.preventDefault(),t.go("<")}),991<window.innerWidth&&t.mount();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?t.destroy():t.mount()})},initUsefulMaterialAccordion=()=>{var e=document.querySelector(".scr_polezn_material_art6__text");document.querySelector(".scr_polezn_material_art6__btn").addEventListener("click",()=>{e.classList.toggle("active")})},initSmTakzheAccordion=()=>{var e=document.querySelector(".scr_sm_takzhe_art6__wrapper"),t=document.querySelector(".scr_sm_takzhe_art6__more");t.addEventListener("click",()=>{e.classList.contains("active")?(e.classList.remove("active"),t.textContent="Показать больше"):(e.classList.add("active"),t.textContent="Скрыть")})},initWatchAlsoAccordion=()=>{document.querySelectorAll(".watch_more_toggle_button").forEach(t=>t.addEventListener("click",()=>{var e=t.previousElementSibling;e.classList.contains("active")?(e.classList.remove("active"),t.firstChild.textContent="Показать все"):(e.classList.add("active"),t.firstChild.textContent="Скрыть")}))},initModalInfo=()=>{var e=Array.from(document.querySelectorAll(".first_scr_main_art6__help")),t=document.querySelector(".scr_info_modal"),r=document.body,c=document.querySelector(".header_art6"),o=document.querySelector(".scr_info_modal__btn"),s=document.querySelector(".scr_info_modal__overlay");toggleModal({buttons_open:e,client_modal:t,body:r,header:c,close_btn:o,overlay:s})},initPinProjectImage=()=>{ScrollTrigger.matchMedia({"(min-width: 768px)":function(){ScrollTrigger.create({trigger:".scr_perv_keys_art6__wrapper",start:"-=5% top",endTrigger:".scr_perv_keys_art6__descr",end:"bottom bottom",pin:".scr_perv_keys_art6__img",pinSpacing:!1})}})},initYoutubeVideo=e=>{e.forEach(r=>{var e=r.dataset.video,c=e.substring("https://youtu.be/".length,e.length);r.addEventListener("click",()=>{var e,t;r.classList.contains("preview-removed")||(e=c,(t=document.createElement("iframe")).classList.add("video-iframe"),t.setAttribute("src","https://www.youtube.com/embed/"+e+"?rel=0&showinfo=0&autoplay=1"),t.setAttribute("title","YouTube video player"),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;"),e=t,r.querySelector(".video_blur").remove(),r.querySelector(".video_preview").remove(),r.append(e),r.classList.add("preview-removed"))})})},initReviewsSlider=()=>{var t,e,r,c,o,s,a=Array.from(document.querySelectorAll(".scr_otzyvy_full__wrapper img")),i=Array.from(document.querySelectorAll(".scr_otzyvy__item"));a.length<1||i.length<1||(e=document.querySelector(".scr_otzyvy_full__nav"),1===a.length&&e.classList.add("hidden"),t=document.querySelector(".scr_otzyvy_full"),e=document.querySelector(".scr_otzyvy_full__overlay"),r=document.querySelector(".scr_otzyvy_full__close"),c=document.querySelector(".scr_otzyvy_full__prev"),o=document.querySelector(".scr_otzyvy_full__next"),s=0,i.forEach(e=>{e.addEventListener("click",e=>{document.body.classList.add("lock"),t.classList.add("active"),s=i.indexOf(e.currentTarget),a.forEach(e=>e.classList.remove("active")),a[s].classList.add("active"),0===s?c.classList.add("disabled"):c.classList.remove("disabled"),s===a.length-1?o.classList.add("disabled"):o.classList.remove("disabled"),setTimeout(()=>a.forEach(e=>e.classList.remove("without-transition")),700)})}),[e,r].forEach(e=>e.addEventListener("click",()=>{document.body.classList.remove("lock"),t.classList.remove("active"),a.forEach(e=>e.classList.add("without-transition"))})),c.addEventListener("click",()=>{a[s].classList.remove("active"),a[--s].classList.add("active"),o.classList.remove("disabled"),s<1&&c.classList.add("disabled")}),o.addEventListener("click",()=>{a[s].classList.remove("active"),a[++s].classList.add("active"),c.classList.remove("disabled"),s>=a.length-1&&o.classList.add("disabled")}))};document.addEventListener("DOMContentLoaded",function(e){initHeader(),toggleBecomeClient();{var t,t;(t=document.querySelector(".scr_text_director_art6__consultation"))&&toggleConsultationModal(),changeCity(),(t=document.querySelector(".scr_komanda_art6__slider"))&&initTeamSlider()}document.querySelector(".scr_voprosy_art6__question")&&initQuestionsAccordion(),document.querySelector(".scr_tematiki_art6__group")&&initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),document.querySelector(".scr_company_art6__person")&&initCompanyPersonsAnimation(),document.querySelector(".scr_klienty_onas_art6__pdf")&&handleShowReviewButtons(),document.querySelector(".scr_rezultat_keysa_art6__img")&&showReviewOnProjectPage(),document.querySelector(".required")&&checkRequiredInputs(),0<document.forms.length&&formValidation();document.querySelector(".scr_success_msg_art6")&&handleSuccessMsgModal();var t=0,r=document.querySelector(".project"),t=r?767:991,c=!1;window.innerWidth>t&&(gsap.registerPlugin(ScrollTrigger),document.body.classList.contains("scrolling-titles-exist")&&startScrollingBlockAnimation(),c=!0,document.querySelector(".index")&&initAnimation(),r&&initPinProjectImage());window.matchMedia(`(max-width: ${t}px)`).addEventListener("change",e=>{e.matches||c||(gsap.registerPlugin(ScrollTrigger),document.body.classList.contains("scrolling-titles-exist")&&startScrollingBlockAnimation(),document.querySelector(".index")&&initAnimation(),r&&initPinProjectImage())}),document.querySelector(".scr_instrumtech_art6__slider")&&initScrInstrumtechSlider();document.querySelector(".scr_polezn_material_art6")&&initUsefulMaterialAccordion();t=document.querySelector(".scr_sm_takzhe_art6");t&&initSmTakzheAccordion(),t&&initWatchAlsoAccordion();document.querySelector(".scr_info_modal")&&initModalInfo();t=Array.from(document.querySelectorAll(".video"));0<t.length&&initYoutubeVideo(t),initReviewsSlider()});