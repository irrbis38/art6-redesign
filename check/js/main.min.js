...
var initHeader=()=>{var t=Array.from(document.querySelectorAll(".header_art6__item-has-submenu")),r=Array.from(document.querySelectorAll(".header_art6__item-has-submenu button")),o=e=>{e.target.closest("li").classList.add("active")},c=e=>e.target.classList.remove("active"),a=()=>{r.forEach(e=>e.addEventListener("mouseover",o)),t.forEach(e=>e.addEventListener("mouseleave",c))};991<window.innerWidth&&a();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(r.forEach(e=>e.removeEventListener("mouseover",o)),t.forEach(e=>e.removeEventListener("mouseleave",c))):a()});var e=Array.from(document.querySelectorAll(".header_art6__mobile-item-has-submenu button")),i=e=>{var t=e.target.parentElement,r=e.target.nextElementSibling;t.classList.contains("submenu-opened")?requestAnimationFrame(()=>{t.classList.remove("submenu-opened"),r.style.maxHeight=0}):requestAnimationFrame(()=>{t.classList.add("submenu-opened"),r.style.maxHeight=r.scrollHeight+"px"})},s=(e.forEach(e=>e.addEventListener("click",i)),document.body),d=document.getElementById("header"),e=document.getElementById("burger-button"),_=document.querySelectorAll(".header_art6__mobile-item-has-submenu ul");e.addEventListener("click",e=>{d.classList.toggle("mobile-menu-open"),s.classList.toggle("lock"),_.forEach(e=>{requestAnimationFrame(()=>{e.parentElement.classList.remove("submenu-opened"),e.style.maxHeight=0})})});{let r=window.scrollY||document.documentElement.scrollTop,o,c=0,a=0;const n=document.querySelector(".header_art6"),l=document.body.classList.contains("company-page")&&992<=window.innerWidth?700:100;return void window.addEventListener("scroll",()=>{if(o=window.scrollY||document.documentElement.scrollTop,o>r?c=2:o<r&&(c=1),c!==a){var e=c,t=o;if(e===2&&t>l){if(!n.classList.contains("mobile-menu-open")){n.classList.add("hide");a=e}}else if(e===1){n.classList.remove("hide");a=e}}r=o})}},initSmothScroll=()=>{992<=window.innerWidth&&luxy.init();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches||luxy.init()})},initTeamSlider=()=>{new Swiper(".scr_komanda_art6__slider",{slidesPerView:1,loop:!0,navigation:{nextEl:".scr_komanda_art6__next",prevEl:".scr_komanda_art6__prev"},breakpoints:{576:{slidesPerView:2,spaceBetween:20},768:{spaceBetween:48},992:{slidesPerView:3,spaceBetween:20},1301:{slidesPerView:4,spaceBetween:20}}})},initQuestionsAccordion=()=>{var e=Array.from(document.querySelectorAll(".scr_voprosy_art6__question")),t=e.map(e=>e.children[0]),c=(e.map(e=>e.children[1]),e[0].children[1],[]);t.forEach(o=>o.addEventListener("click",()=>{var e=o.parentElement,t=e.classList.contains("active"),r=o.nextElementSibling;t?(e.classList.remove("active"),r.style.maxHeight=null,c=c.filter(e=>e!==r)):(e.classList.add("active"),r.style.maxHeight=r.scrollHeight+"px",c.push(r))})),window.addEventListener("resize",()=>{0<c.length&&c.forEach(e=>{e.style.maxHeight=e.scrollHeight+"px"})})},initAccordion=(e,o)=>{var c=Array.from(document.querySelectorAll(e)),a=null,t=e=>{var t,r,e=e.target.closest(o);e&&(r=(t=e.parentElement).classList.contains("one-per-view"),e=e.nextElementSibling,a=t.classList.contains("active")?(t.classList.remove("active"),e.style.maxHeight=null):(r&&c.forEach(e=>{e.classList.remove("active"),e.children[1].style.maxHeight=null}),t.classList.add("active"),e.style.maxHeight=e.scrollHeight+"px",e))},r=()=>a&&(a.style.maxHeight=a.scrollHeight+"px");window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?c.forEach(e=>{e.addEventListener("click",t),window.addEventListener("resize",r)}):(c.forEach(e=>e.classList.remove("active")),c.forEach(e=>{e.removeEventListener("click",t),window.removeEventListener("resize",r)}))}),window.innerWidth<=991&&(c.forEach(e=>e.addEventListener("click",t)),window.addEventListener("resize",r))},toggleModal=e=>{const{buttons_open:t,client_modal:r,body:o,header:c,close_btn:a,overlay:i,isModalReviews:s=!1}=e;t.forEach(e=>e.addEventListener("click",()=>{r.classList.add("active"),o.classList.add("lock")})),[a,i].forEach(e=>e.addEventListener("click",()=>{var e;r.classList.remove("active"),c.classList.contains("mobile-menu-open")||o.classList.remove("lock"),!s||(e=document.querySelector(".scr_review_modal__image img"))&&(e.src="")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(r.classList.remove("active"),c.classList.contains("mobile-menu-open")||o.classList.remove("lock"))})},toggleBecomeClient=()=>{var e=document.querySelector(".header_art6__cta"),t=document.querySelector(".header_art6__mobile-cta"),r=document.querySelector(".scr_b_client_art6"),o=document.body,c=document.querySelector(".scr_b_client_art6__btn"),a=document.querySelector(".scr_b_client_art6__overlay"),i=document.querySelector(".header_art6");toggleModal({buttons_open:[e,t],client_modal:r,body:o,header:i,close_btn:c,overlay:a})},toggleConsultationModal=()=>{var e=document.querySelector(".scr_text_director_art6__consultation"),t=document.querySelector(".scr_b_consultation_art6"),r=document.body,o=document.querySelector(".scr_b_consultation_art6__btn"),c=document.querySelector(".scr_b_consultation_art6__overlay"),a=document.querySelector(".header_art6");toggleModal({buttons_open:[e],client_modal:t,body:r,header:a,close_btn:o,overlay:c})},toggleGetPriceModal=e=>{var t=document.querySelector(".scr_b_get_price"),r=document.body,o=document.querySelector(".scr_b_consultation_art6__close"),c=document.querySelector(".scr_b_get_price__overlay"),a=document.querySelector(".header_art6");t&&o&&c&&a&&toggleModal({buttons_open:[e],client_modal:t,body:r,header:a,close_btn:o,overlay:c})},handleShowReviewButtons=()=>{var e=Array.from(document.querySelectorAll(".scr_klienty_onas_art6__pdf")),t=document.querySelector(".scr_review_modal"),r=document.body,o=document.querySelector(".scr_review_modal__btn"),c=document.querySelector(".scr_review_modal__overlay"),a=document.querySelector(".header_art6"),i=document.querySelector(".scr_review_modal__image img");e.forEach(e=>e.addEventListener("click",()=>{i.src=e.dataset.src})),toggleModal({buttons_open:e,client_modal:t,body:r,header:a,close_btn:o,overlay:c})},showReviewOnProjectPage=()=>{var e=Array.from(document.querySelectorAll(".scr_rezultat_keysa_art6__img")),t=document.querySelector(".scr_review_modal"),r=document.body,o=document.querySelector(".scr_review_modal__btn"),c=document.querySelector(".scr_review_modal__overlay"),a=document.querySelector(".header_art6");document.querySelector(".scr_review_modal__image img");toggleModal({buttons_open:e,client_modal:t,body:r,header:a,close_btn:o,overlay:c})},checkValidity=e=>{e.forEach(e=>e.validity.valueMissing&&e.classList.add("error"))},checkForm=e=>e.some(e=>e.classList.contains("error")),formValidation=()=>{Array.from(document.forms).forEach(r=>r.addEventListener("submit",e=>{e.preventDefault();var t,e=Array.from(r.elements).filter(e=>e.classList.contains("required"));0<e.length&&(checkValidity(e),checkForm(e)||(r.reset(),(e=r.closest(".modal_w"))&&e.classList.remove("active"),e=document.querySelector(".scr_success_msg_art6"),t=document.body,e.classList.add("active"),t.classList.add("lock")))}))},checkRequiredInputs=()=>{var e=document.querySelectorAll(".required");e.forEach(t=>t.addEventListener("input",()=>{var e=t;0<e.value.length?e.classList.remove("error"):e.classList.add("error")}))},handleSuccessMsgModal=()=>{var t=document.querySelector(".scr_success_msg_art6"),r=document.body,e=document.querySelector(".scr_success_msg_art6__btn"),o=document.querySelector(".scr_success_msg_art6__overlay"),c=document.querySelector(".header_art6");[e,o].forEach(e=>e.addEventListener("click",()=>{t.classList.remove("active"),r.classList.remove("lock")})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(t.classList.remove("active"),c.classList.contains("mobile-menu-open")||r.classList.remove("lock"))})},changeCity=()=>{var t=document.querySelector(".scr_footer_art6__offices"),r=document.body,o=document.querySelector(".scr_cities_art6"),e=document.querySelector(".scr_cities_art6__btn"),c=document.querySelector(".scr_cities_art6__overlay"),a=Array.from(document.querySelectorAll(".scr_cities_art6__input")),i=document.querySelector(".scr_cities_art6__search");t.addEventListener("click",()=>{o.classList.add("active"),r.classList.add("lock")}),[e,c].forEach(e=>e.addEventListener("click",()=>{o.classList.remove("active"),r.classList.remove("lock"),i.value="",a.forEach(e=>e.classList.remove("hidden"))})),window.addEventListener("keydown",e=>{"Escape"===e.key&&(o.classList.remove("active"),header.classList.contains("mobile-menu-open")||r.classList.remove("lock"),i.value="",a.forEach(e=>e.classList.remove("hidden")))}),a.forEach(e=>e.addEventListener("click",()=>{o.classList.remove("active"),r.classList.remove("lock"),t.children[1].textContent=e.value,i.value="",a.forEach(e=>e.classList.remove("hidden"))})),i.addEventListener("input",()=>{a.forEach(e=>{e.value.toLowerCase().includes(i.value.toLowerCase())?e.classList.remove("hidden"):e.classList.add("hidden")})})},startScrollingBlockAnimation=()=>{var e=(e,t,r,o)=>{var c=document.querySelector(e),a=document.querySelector(r);function i(){var e=c.scrollWidth;return window.innerWidth<1280?-(e-Number(a.clientWidth-80)):-(e-Number(a.clientWidth)+80)}let s=gsap.matchMedia();s.add("(min-width: 992px)",()=>{gsap.to(c,{x:i,duration:3,ease:"none",scrollTrigger:{trigger:t,start:o,end:()=>"+="+-1*i(),scrub:1.5,pin:!0,invalidateOnRefresh:!0,toggleActions:"play none none reverse"}})})},t=(document.querySelector(".scr_scrolling_right_art6")&&e(".scr_scrolling_right_art6__scroll",".scr_scrolling_right_art6",".scr_scrolling_right_art6 .container","top 10%"),document.querySelector(".scr_keysy_art6")),r=document.querySelector(".our-projects"),t=(t&&e(".scr_keysy_art6__title",".scr_keysy_art6",".scr_keysy_art6 .container",r?"top top":"top 30%"),document.querySelector(".scr_text_director_art6")),r=document.querySelector(".scr_company_art6"),t=(document.querySelector(".company-page")?(r&&e(".scr_company_art6__title",".scr_company_art6",".scr_company_art6__intro .container","top top"),t&&e(".scr_text_director_art6__title",".scr_text_director_art6",".scr_company_art6__intro .container","top top")):(t&&e(".scr_text_director_art6__title",".scr_text_director_art6",".first_scr_main_art6 .container","top top"),r&&e(".scr_company_art6__title",".scr_company_art6",".first_scr_main_art6 .container","top top")),document.querySelector(".first_scr_with_scroll")),r=document.querySelector(".culture-page"),o=document.querySelector(".reviews-page"),c=document.querySelector(".vacancy-page");r||o?t&&e(".first_scr_with_scroll__title",".main",".first_scr_with_scroll .scroll_container","top top"):c||t&&e(".first_scr_with_scroll__title",".first_scr_with_scroll",".first_scr_with_scroll .scroll_container","top top")},initAnimation=()=>{var e=document.querySelector(".first_word .letter");gsap.matchMedia().add("(min-width: 992px)",()=>{gsap.set(e,{y:"-91%"}),gsap.timeline({scrollTrigger:{trigger:".scr_scrolling_right_art6",start:"45% center",end:"60% center",scrub:1,pin:!1,invalidateOnRefresh:!0,duration:3}}).to(e,{y:"0%",ease:"none"})})},initCompanyPersonsAnimation=()=>{var o=Array.from(document.querySelectorAll(".scr_company_art6__person")),c=(o[0].classList.add("active"),o[0].classList.remove("hidden"),o[1].classList.remove("hidden"),0),a=o.length;setInterval(()=>{var e=c%a,t=(c+1)%a,r=(c+2)%a;o[e].classList.add("hidden"),o[e].classList.remove("active"),o[t].classList.add("active"),o[r].classList.remove("hidden"),c++},5e3)},initScrInstrumtechSlider=()=>{var t=null,r=()=>{t=new Swiper(".scr_instrumtech_art6__slider",{slidesPerView:4,spaceBetween:13,loop:!0,navigation:{prevEl:".scr_instrumtech_art6__prev",nextEl:".scr_instrumtech_art6__next"},breakpoints:{1301:{spaceBetween:17},1601:{spaceBetween:20}}})};991<window.innerWidth&&r();window.matchMedia("(max-width: 991px)").addEventListener("change",e=>{e.matches?(t.destroy(),t=null):r()})},initUsefulMaterialAccordion=()=>{var e=document.querySelector(".scr_polezn_material_art6__text");document.querySelector(".scr_polezn_material_art6__btn").addEventListener("click",()=>{e.classList.toggle("active")})},initSmTakzheAccordion=()=>{var e=document.querySelector(".scr_sm_takzhe_art6__wrapper"),t=document.querySelector(".scr_sm_takzhe_art6__more");t.addEventListener("click",()=>{e.classList.contains("active")?(e.classList.remove("active"),t.textContent="Показать больше"):(e.classList.add("active"),t.textContent="Скрыть")})},initWatchAlsoAccordion=()=>{document.querySelectorAll(".watch_more_toggle_button").forEach(t=>t.addEventListener("click",()=>{var e=t.previousElementSibling;e.classList.contains("active")?(e.classList.remove("active"),t.firstChild.textContent="Показать все"):(e.classList.add("active"),t.firstChild.textContent="Скрыть")}))},initModalInfo=()=>{var e=Array.from(document.querySelectorAll(".first_scr_main_art6__help")),t=document.querySelector(".scr_info_modal"),r=document.body,o=document.querySelector(".header_art6"),c=document.querySelector(".scr_info_modal__btn"),a=document.querySelector(".scr_info_modal__overlay");toggleModal({buttons_open:e,client_modal:t,body:r,header:o,close_btn:c,overlay:a})},initPinProjectImage=()=>{var e=document.querySelector(".scr_perv_keys_art6__descr"),t=document.querySelector(".scr_perv_keys_art6__mobile_img");e&&t&&ScrollTrigger.matchMedia({"(min-width: 992px)":function(){ScrollTrigger.create({trigger:".scr_perv_keys_art6__wrapper",start:"-=5% top",end:()=>`+=${e.scrollHeight-t.clientHeight-60}px`,pin:".scr_perv_keys_art6__mobile_img",pinSpacing:!1})}})},initYoutubeVideo=e=>{e.forEach(r=>{var e=r.dataset.video,o=e.substring("https://youtu.be/".length,e.length);r.addEventListener("click",()=>{var e,t;r.classList.contains("preview-removed")||(e=o,(t=document.createElement("iframe")).classList.add("video-iframe"),t.setAttribute("src","https://www.youtube.com/embed/"+e+"?rel=0&showinfo=0&autoplay=1"),t.setAttribute("title","YouTube video player"),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;"),e=t,r.querySelector(".video_blur").remove(),r.querySelector(".video_preview").remove(),r.append(e),r.classList.add("preview-removed"))})})},initVideoSourceSelection=e=>{var t=document.querySelectorAll(".video_source_selection__btn_mobile"),c=(0<t.length&&t.forEach(e=>{e.addEventListener("click",()=>{var t,r=e.closest(".video_source_selection");r&&(r.classList.add("active"),t=e=>{e.target.closest(".video_source_selection")!==r&&(r.classList.remove("active"),window.removeEventListener("click",t))},window.addEventListener("click",t))})}),(e,t,r)=>{var o="",c="";return"vk"===e?(o="https://vk.com/video_ext.php?oid=",c="&hd=2&autoplay=1",console.log(o+t+"&id="+r+c),o+t+"&id="+r+c):"youtube"===e?(o="https://www.youtube.com/embed/")+r+(c="?rel=0&showinfo=0&autoplay=1"):null}),l=(e,t,r)=>{var o=document.createElement("iframe");return o.classList.add("video_source_selection__iframe"),o.setAttribute("src",c(e,t,r)),o.setAttribute("frameborder","0"),o.setAttribute("allowfullscreen",""),"youtube"===e?(o.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;"),o.setAttribute("title","YouTube video player")):"vk"===e&&o.setAttribute("allow","autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock;"),o};e.forEach(n=>{[n.querySelector(".video_source_selection__vk"),n.querySelector(".video_source_selection__youtube")].forEach(e=>{e.addEventListener("click",e=>{var t,r,o,c,a,e=e.target.classList.contains("video_source_selection__vk")?"vk":"youtube",i=(n.classList.remove("active"),document.body.classList.add("lock"),document.querySelector(".video_source_selection__modal")),s=(i||((s=document.createElement("div")).classList.add("video_source_selection__modal"),s.innerHTML=`
    ...
    `,document.body.append(s),(i=s).querySelectorAll(".js-video-modal-close").forEach(e=>{e.addEventListener("click",()=>{i.classList.remove("active"),document.body.classList.remove("lock");var e=i.querySelector(".video_source_selection__wrapper");Array.from(e.children).forEach(e=>e.remove())})})),i.classList.add("active"),i.querySelector(".video_source_selection__wrapper"));t=s,e=e,o=(r=n).dataset.vk,r=r.dataset.youtube,c="",a=null,"vk"===e?(o=o.substring("https://vk.com/video".length,o.length).split("_"),a=l("vk",o[0],o[1])):"youtube"===e&&(c=r.substring("https://youtu.be/".length,r.length),a=l("youtube",null,c)),t.append(a)})})})},initReviewsSlider=()=>{var r,o=Array.from(document.querySelectorAll(".scr-image-item")),c=document.querySelector(".scr_image_full"),e=document.querySelector(".scr_image_full__close"),t=document.querySelector(".scr_image_full__overlay");o.length<1||(r=new Swiper(".scr_image_full__slider",{lazy:!0,effect:"fade",navigation:{prevEl:".scr_image_full__prev",nextEl:".scr_image_full__next"}}),o.forEach(t=>t.addEventListener("click",()=>{var e=o.indexOf(t);r.slideTo(e,0,!1),c.classList.add("active"),document.body.classList.add("lock")})),[e,t].forEach(e=>e.addEventListener("click",()=>{c.classList.remove("active"),document.body.classList.remove("lock")})))},initCompanyPageSlider=()=>{var t,r,e=document.querySelector(".scr_karusel_foto_art6__slider");e&&(t=null,r=()=>{t=new Swiper(e,{slidesPerView:"auto",spaceBetween:0,navigation:{nextEl:".scr_karusel_foto_art6__next",prevEl:".scr_karusel_foto_art6__prev"}})},767<window.innerWidth&&r(),window.matchMedia("(min-width: 768px)").addEventListener("change",e=>{e.matches?r():(t&&t.destroy(),t=null)}))},initMoreButtonOnMobile=(e,r)=>{var t=t=>{r.forEach(e=>{e.classList[t]("visible")}),e.classList[t]("hidden")};e.addEventListener("click",()=>t("add")),window.matchMedia("(min-width: 768px)").addEventListener("change",e=>{e.matches&&t("remove")})},doCreateMapScript=t=>{setTimeout(function(){var e=document.createElement("script");e.async=!1,e.src="https://api-maps.yandex.ru/2.1/?apikey=key&lang=ru_RU",document.body.appendChild(e),e.onload=()=>t()},3e3)},initMap=()=>{var r=document.getElementById("contacts-map");r&&ymaps.ready(()=>{var e,t="",t=(t=r.dataset&&r.dataset.coords?r.dataset.coords:t)?t.split(",").map(e=>Number(e.trim())):[45.03750207460071,38.991877999999915];ymaps&&(e=new ymaps.Map("contacts-map",{center:t,zoom:15}),t=new ymaps.Placemark(t,{},{iconLayout:"default#image",iconImageHref:"images/mark.svg",iconImageSize:[100,100],iconImageOffset:[-60,-80]}),e.controls.remove("geolocationControl"),e.controls.remove("searchControl"),e.controls.remove("trafficControl"),e.controls.remove("typeSelector"),e.controls.remove("fullscreenControl"),e.controls.remove("rulerControl"),e.geoObjects.add(t))})},initPinVacancy=()=>{var r,e=document.querySelector(".scr_vacancy"),t=document.querySelector(".scr_vacancy__menu");e&&t&&(ScrollTrigger.matchMedia({"(min-width: 1500px)":function(){ScrollTrigger.create({trigger:".scr_vacancy",start:"-=5% top",endTrigger:".scr_vacancy",end:"bottom center",pin:".scr_vacancy__menu",pinSpacing:!1})}}),r=Array.from(document.querySelectorAll(".scr_vacancy__link")),Array.from(document.querySelectorAll(".scr_vacancy__block")).forEach((e,t)=>{ScrollTrigger.create({trigger:e,start:"top +=35%",end:"bottom +=35%",toggleClass:{targets:[r[t],e],className:"active"},onLeaveBack:()=>{0===t&&(r[t].classList.add("active"),e.classList.add("active"))}})}),smoothScroll(".scr_vacancy__link"))},initPinCareer=()=>{var e,t,r=document.querySelector(".scr_karyera_preimushestva_art6__list");r&&(e=document.querySelector(".scr_karyera_preimushestva_art6"),t=document.querySelector(".scr_karyera_vakansii_art6__container"),ScrollTrigger.matchMedia({"(min-width: 1601px)":()=>{ScrollTrigger.create({trigger:".scr_karyera_preimushestva_art6__list",start:"-=95px top",end:()=>`+=${e.scrollHeight-r.scrollHeight+253+t.scrollHeight}px`,pin:".scr_karyera_preimushestva_art6__list",pinSpacing:!1,invalidateOnRefresh:!0})}}))},initPinCareerList=()=>{var e,t;document.querySelector(".scr_karyera_vakansii_art6__aside")&&(e=document.querySelector(".vacancies__list"),t=document.querySelector(".scr_karyera_vakansii_art6__aside__wrapper"),ScrollTrigger.matchMedia({"(min-width: 992px)":function(){ScrollTrigger.create({trigger:".vacancies__list",start:"-=5% top",end:()=>`+=${e.scrollHeight-t.scrollHeight-48}px`,pin:".scr_karyera_vakansii_art6__aside__wrapper",pinSpacing:!1})}}))},smoothScroll=e=>{var t,e=Array.from(document.querySelectorAll(e));e.length<1||(t=e=>{e.preventDefault();var e=document.getElementById(e.target.getAttribute("href").slice(1));e&&(e=e.getBoundingClientRect().top-100,window.scrollBy({top:e,behavior:"smooth"}))},e.forEach(e=>{e.addEventListener("click",t)}))},initPinHistoryGoals=()=>{var e=document.querySelector(".scr_istoriya_art6__goals"),t=document.querySelector(".scr_istoriya_art6__container");ScrollTrigger.matchMedia({"(min-width: 1301px)":()=>{ScrollTrigger.create({trigger:".scr_istoriya_art6__goals",start:"-=95px top",end:()=>`+=${t.scrollHeight-e.clientHeight}px`,pin:".scr_istoriya_art6__goals",pinSpacing:!1})}})},setInlineOrders=()=>{var e=document.querySelectorAll(".scr_keysy_art6__item"),t=e.length;const r=Math.ceil(t/2);var o=1,c=2;t<1||e.forEach((e,t)=>{t<r?(e.style.order=o,o+=2):(e.style.order=c,c+=2)})},initCookieMsg=()=>{var e=document.querySelector(".scr_cookie_msg"),t=e.querySelector(".scr_cookie_msg__close");e&&t&&(localStorage.getItem("shown_cookie_msg")||(e.classList.add("active"),localStorage.setItem("shown_cookie_msg","true")),t.addEventListener("click",()=>{e.classList.remove("active")}))};document.addEventListener("DOMContentLoaded",function(e){initHeader(),toggleBecomeClient();{var t,t,t,t,t,t,t,t;(t=document.querySelector(".scr_text_director_art6__consultation"))&&toggleConsultationModal(),0<(t=document.querySelectorAll(".js-get-price-btn")).length&&t.forEach(e=>toggleGetPriceModal(e)),changeCity(),(t=document.querySelector(".scr_komanda_art6__slider"))&&initTeamSlider(),(t=document.querySelector(".scr_voprosy_art6__question"))&&initQuestionsAccordion(),(t=document.querySelector(".scr_tematiki_art6__group"))&&initAccordion(".scr_tematiki_art6__group",".scr_tematiki_art6__heading"),initAccordion(".scr_footer_art6__group-submenu",".scr_footer_art6__heading"),(t=document.querySelector(".scr_company_art6__person"))&&initCompanyPersonsAnimation(),(t=document.querySelector(".scr_klienty_onas_art6__pdf"))&&handleShowReviewButtons(),(t=document.querySelector(".scr_rezultat_keysa_art6__img"))&&showReviewOnProjectPage();var t,t=((t=document.querySelector(".required"))&&checkRequiredInputs(),0<document.forms.length&&formValidation(),document.querySelector(".scr_success_msg_art6")&&handleSuccessMsgModal(),0),r=document.querySelector(".project"),t=r?767:991,o=!1}window.innerWidth>t&&(gsap.registerPlugin(ScrollTrigger),document.body.classList.contains("scrolling-titles-exist")&&startScrollingBlockAnimation(),o=!0,document.querySelector(".index")&&initAnimation(),r&&initPinProjectImage());window.matchMedia(`(max-width: ${t}px)`).addEventListener("change",e=>{e.matches||o||(gsap.registerPlugin(ScrollTrigger),document.body.classList.contains("scrolling-titles-exist")&&startScrollingBlockAnimation(),document.querySelector(".index")&&initAnimation(),r&&initPinProjectImage())}),document.querySelector(".scr_instrumtech_art6__slider")&&initScrInstrumtechSlider();document.querySelector(".scr_polezn_material_art6")&&initUsefulMaterialAccordion();var t=document.querySelector(".scr_sm_takzhe_art6"),c=document.querySelector(".services-list");t&&!c&&initSmTakzheAccordion(),t&&!c&&initWatchAlsoAccordion();document.querySelector(".scr_info_modal")&&initModalInfo();var a,i,t=Array.from(document.querySelectorAll(".video")),c=(0<t.length&&initYoutubeVideo(t),Array.from(document.querySelectorAll(".video_source_selection")));0<c.length&&initVideoSourceSelection(c),document.querySelector(".reviews-page")&&initReviewsSlider(),document.querySelector(".achievements-page")&&initReviewsSlider(),document.querySelector(".company-page")&&(initCompanyPageSlider(),t=document.querySelector(".scr_karusel_foto_art6__more"),c=document.querySelectorAll(".scr_karusel_foto_art6__slide"),a=document.querySelector(".scr_komanda_foto_art6__more"),i=document.querySelectorAll(".scr_komanda_foto_art6__item"),initMoreButtonOnMobile(t,c),initMoreButtonOnMobile(a,i)),document.querySelector(".contacts-page")&&doCreateMapScript(initMap);document.querySelector(".vacancy-page")&&initPinVacancy();t=document.querySelector(".career-page");t&&initPinCareer(),t&&initPinCareerList(),document.querySelector(".history-page")&&initPinHistoryGoals(),setInlineOrders(),initCookieMsg()});